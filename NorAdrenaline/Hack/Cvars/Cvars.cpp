...
void CCvars::Init()
{
	...
	autostrafe = false;
	knifebot = false;
	use_all_undetected = false;
	strafeemulator = false;
	name_stealer = false;
	jumpbug = true;
	debug = false;
}
...
void CFunctions::SaveCvars()
{
	...
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "custom_fov", dtoa(s, cvar.custom_fov));
	...
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "esp_boxfill", dtoa(s, cvar.esp_boxfill));
	...
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "bhop_mode", dtoa(s, cvar.bhop_mode));
	...
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "ddrun", dtoa(s, cvar.ddrun));
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "autostrafe", dtoa(s, cvar.autostrafe));
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "strafeemulator", dtoa(s, cvar.strafeemulator));
	...
	g_Utils.cIniWrite(g_pGlobals.IniPath, Section, "aimbot_key", dtoa(s, cvar.aimbot_key));
...
void CFunctions::LoadCvars()
{
	...
	cvar.custom_fov = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "custom_fov", "0"));
	...
	cvar.esp_boxfill = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "esp_boxfill", "0"));
	...
	cvar.aimbot_key = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "aimbot_key", "-1"));

	cvar.bunnyhop = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "bunnyhop", "0"));
	cvar.ddrun = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "ddrun", "0"));
	//cvar.thirdperson = atof(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "thirdperson", "0"));
	cvar.autostrafe = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "autostrafe", "0"));
	cvar.strafeemulator = atoi(g_Utils.cIniRead(g_pGlobals.IniPath, Section, "strafeemulator", "0"));
